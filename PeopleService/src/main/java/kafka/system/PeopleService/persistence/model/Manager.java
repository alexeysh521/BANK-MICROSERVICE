...
public class Manager {
    ...
    public Manager(UUID id, LocalDateTime timeStamp) {
        this.id = id;
        this.timeStamp = timeStamp;
    }

    public Manager(String firstName, String overageName, String lastName, String phone, String passportNumber, String passportSerial, Genders gender, LocalDateTime dateOfBirth) {
