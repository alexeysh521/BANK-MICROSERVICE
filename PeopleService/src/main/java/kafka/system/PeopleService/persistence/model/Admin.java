...
public class Admin {
    ...
    public Admin(UUID id, LocalDateTime timeStamp) {
        this.id = id;
        this.timeStamp = timeStamp;
    }

    public Admin(String firstName, String overageName, String lastName, String phone, String passportNumber, String passportSerial, Genders gender, LocalDateTime dateOfBirth) {
